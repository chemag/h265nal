...
TEST_F(H265SliceSegmentLayerParserTest, TestSliceContainsShortTermRefPiCSet) {
  const uint8_t vps[] = {
   0x40, 0x01, 0x0c, 0x01, 0xff, 0xff, 0x01, 0x60, 0x00, 0x00, 0x03, 0x00, 0xb0, 0x00, 0x00, 0x03, 0x00, 0x00, 0x03, 0x00, 0x96
  };
  const uint8_t sps[] = {
   0x42, 0x01, 0x01, 0x01, 0x60, 0x00, 0x00, 0x03, 0x00, 0xb0, 0x00, 0x00, 0x03, 0x00, 0x00, 0x03, 0x00, 0x96, 0xa0, 0x05, 0x82, 0x00, 0x50, 0x16, 0x20, 0x5e, 0xe4, 0x59, 0x14, 0xbf, 0xf2, 0xe7, 0xf1, 0x3f, 0xa9, 0xb8, 0x10
  };
  const uint8_t pps[] = {
  ...
  const uint8_t slice[] = {
   0x02, 0x01, 0xd0, 0x53, 0x17, 0x62, 0x0a, 0x05, 0x02, 0x70, 0x34, 0x38,
   0x56, 0x0e, 0xc3, 0x48, 0x7c, 0xbf, 0x9d, 0xaa, 0xe5, 0x51, 0x8c, 0x8b,
   0x40, 0x91, 0xbd, 0x9e, 0x49, 0x95, 0x1a, 0x61, 0x90, 0x6f, 0x42, 0x25,
   0x19, 0x50, 0xe6, 0xfb, 0x5d, 0x4f, 0x12, 0x72, 0x44, 0xdc, 0x6c, 0x96,
   0x0a, 0xbd, 0x7e, 0x87, 0x60, 0xc0,
  };
  auto result = H265NalUnitParser::ParseNalUnit(
      slice, arraysize(slice),
      &bitstream_parser_state);
